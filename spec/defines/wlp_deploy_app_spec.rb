    ...
    on_supported_os.each do |os, facts|
      context "on #{os}" do
        ...
        context "wlp::deploy_app as dropin" do
          let(:params) { { :user => 'wlp', :base_path => '/opt/ibm/wlp', :type => 'dropin', :server => 'testserver', :install_src => '/vagrant/hello_world.war' } }
        ...
        context "wlp::deploy_app deleting dropin" do
          let(:params) { { :user => 'wlp', :base_path => '/opt/ibm/wlp', :type => 'dropin', :server => 'testserver', :install_src => '/vagrant/hello_world.war', :ensure => 'absent' } }
          it { is_expected.to compile.with_all_deps }
        ...
        context "wlp::deploy_app as static" do
          let(:params) { { :user => 'wlp', :base_path => '/opt/ibm/wlp', :type => 'static', :server => 'testserver', :install_src => '/vagrant/hello_world.war' } }
          it { is_expected.to compile.with_all_deps }
          it { is_expected.to contain_archive('hello_world.war').with({
        ...
        context "wlp::deploy_app deleting static" do
          let(:params) { { :user => 'wlp', :base_path => '/opt/ibm/wlp', :type => 'static', :server => 'testserver', :install_src => '/vagrant/hello_world.war', :ensure => 'absent' } }
          it { is_expected.to compile.with_all_deps }
        ...
        context "wlp::deploy_app invalid args dropin" do
          let(:params) { { :user => 'wlp', :base_path => '/opt/ibm/wlp', :type => 'special', :server => 'testserver', :install_src => '/vagrant/hello_world.war' } }
